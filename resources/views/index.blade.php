...
<section id="homepage-hero">
    <div class="content">
        ...
        <button><a href="/courses">ابحث هنا</a></button>
    </div>
</section>
...
<section class="courses">
    <div class="courses-header d-flex justify-content-between align-items-center">
        ...
        <a href="/courses" class="d-flex justify-content-center align-items-center">اكتشف المزيد<i class="bx bx-chevron-left"></i></a>
    </div>
    ...
    <x-scroll-buttons :scrollValue="333" :idName="'courses-content'"/>
