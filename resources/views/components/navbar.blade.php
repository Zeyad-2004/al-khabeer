...
<nav id="main-navbar">
    ...
    <a href="/index" class="logo-image logo">
    </a>
    <div class="navbar-content">
        <div class="part">
            <a href="/index" class=" {{((in_array($pageName, ["","index"]))? 'navbar-active': "" )}}">الرئيسية</a>
        </div>
    ...
    @if (true)
        ...
        <div class="user">
            <a href="/cart" style="transition: 0.3s;" class="active  {{ ((in_array($pageName, ["cart"]))? 'navbar-active': "") }}">
    ...
    @else
        ...
        <div class="login-register">
            <a href="/login">تسجيل الدخول / تسجيل جديد</a>
        </div>
...
<nav id="mobile-main-navbar">
    <div class="container">
        <div class="icon {{ ((in_array($pageName, ["index"]))? 'mobile-navbar-active-icon': "") }}">
            <a href="/index">
        ...
        <div class="icon {{ ((in_array($pageName, ["profile"]))? 'mobile-navbar-active-icon': "") }}">
            <a 
                @if(true)
                    href="/profile/1" 
        ...
        <div class="icon {{ ((in_array($pageName, ["cart"]))? 'mobile-navbar-active-icon': "") }}">
            <a href="/cart">
        ...
        <div class="icon {{ (in_array($pageName, ["courses", "section-courses", "course-content"]))? 'mobile-navbar-active-icon': ""}} ">
            <a href="/courses">
