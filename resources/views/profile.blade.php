...
<section id="profile">
    ...
    <section id="fixed-section">
        ...
        <div class="sections">
            ...
            <div class="partition {{ ($page_id == 1)? "active": "" }}">
                <a href="/profile/1">
                    <h1>تفاصيل الحساب</h1>
                </a>
            </div>
            ...
            <div class="partition {{ ($page_id == 2)? "active": "" }}">
                <a href="/profile/2">
                    <h1>دوراتي</h1>
                </a>
            </div>
            ...
            <div class="partition {{ ($page_id == 3)? "active": "" }}">
                <a href="/profile/3">
                    <h1>شهاداتي</h1>
                </a>
            </div>
        ...
        @elseif ($page_id == 2)
            ...
            <section class="section-content-2">
                ...
                <div class="content">
                    <div id="profile-courses" class="card-container d-flex justify-content-center gap-5 flex-wrap">
                        ...
                        @for ($i = 1; $i <= 9; $i++)
                            ...
                            <div class="course-preview-card" style="width:285px;height:290px;">
                                <img src="{{ asset("media/main/autocad.png") }}" alt="card-pic" class="card-pic">
                    ...
                    <x-scroll-buttons :scrollValue="333" :idName="'profile-courses'"/>
