            ...
            <div class="left-section-wrapper">
                <div class="header">
                    ...
                    <?php if (isset($_POST['sub'])) : ?>
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16" style="cursor:pointer;" onclick="window.history.back();" hover>
                        ...
                        <div class="card-form">
                            <form class="card" method="post" action="">
                                ...
                                <div class="btt">
                                    <div class="radio">
                                        <div>
                                            <input class="form-check-input login-check-box checkbox-danger" type="checkbox" id="checkboxNoLabel" value="" aria-label="...">
                                        </div>
