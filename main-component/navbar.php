...
<nav id="main-navbar">
    ...
    <?php if (true) : ?>
        <div class="user">
            <a href="cart.php" style="transition: 0.3s;" class="active <?php if (pathinfo($_SERVER['PHP_SELF'], PATHINFO_FILENAME) === "cart") echo 'navbar-active'; ?>">
...
<nav id="mobile-main-navbar">
    <div class="container">
        ...
        <div class="icon <?php if (pathinfo($_SERVER['PHP_SELF'], PATHINFO_FILENAME) === "cart") echo 'mobile-navbar-active-icon'; ?>">
            <a href="cart.php">
